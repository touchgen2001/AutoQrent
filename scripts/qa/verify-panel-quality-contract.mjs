...
const publicVehicleJsonLd = read('lib/public-vehicle-jsonld.ts')
...
const checks = [
  ...
  [
    ...
    showroom.includes("href: '#talep'")
      ...
      && showroom.includes('heroHighlights')
  ...
  [
    ...
    showroom.includes('var(--showroom-accent)')
      ...
      && showroom.includes('getShowroomPalette')
      && showroom.includes('getHeroShell')
  ...
  [
    ...
    publicShowroomSeo.includes(" '@type': 'AutoDealer'")
      ...
      && publicVehicleJsonLd.includes('buildVehicleBreadcrumbJsonLd')
