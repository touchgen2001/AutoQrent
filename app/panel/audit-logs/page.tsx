...
const actionLabelMap: Record<PanelAuditAction, string> = {
  ...
  lead_follow_up_change: 'Müşteri Talebi Takip Tarihi Güncelleme',
  lead_whatsapp_open: 'WhatsApp Görüşmesi Başlatma',
  reservation_create: 'Rezervasyon Talebi',
  reservation_update: 'Rezervasyon Güncelleme',
  review_moderate: 'Yorum Moderasyonu',
  vehicle_restore: 'Araç Geri Alma',
  customer_task_create: 'Randevu / Takip Oluşturma',
  customer_task_status_change: 'Randevu / Takip Durumu Güncelleme',
  ...
  vehicle_social_image_download: 'Araç Sosyal Görseli İndirme',
  vehicle_social_image_share: 'Araç Sosyal Görseli Paylaşımı',
  ...
  registration_funnel_event: 'Kayıt Akışı Analitiği',
...
const actionBadgeMap: Record<PanelAuditAction, string> = {
  ...
  lead_follow_up_change: 'bg-amber-500/10 text-amber-700 border-amber-500/30',
  lead_whatsapp_open: 'bg-green-500/10 text-green-700 border-green-500/30',
  reservation_create: 'bg-cyan-500/10 text-cyan-700 border-cyan-500/30',
  reservation_update: 'bg-blue-500/10 text-blue-700 border-blue-500/30',
  review_moderate: 'bg-yellow-500/10 text-yellow-700 border-yellow-500/30',
  vehicle_restore: 'bg-emerald-500/10 text-emerald-700 border-emerald-500/30',
  customer_task_create: 'bg-cyan-500/10 text-cyan-700 border-cyan-500/30',
  customer_task_status_change: 'bg-teal-500/10 text-teal-700 border-teal-500/30',
  ...
  vehicle_social_image_download: 'bg-pink-500/10 text-pink-700 border-pink-500/30',
  vehicle_social_image_share: 'bg-fuchsia-500/10 text-fuchsia-700 border-fuchsia-500/30',
  ...
  registration_funnel_event: 'bg-violet-500/10 text-violet-700 border-violet-500/30',
