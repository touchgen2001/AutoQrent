...
const sections = [
  {
    ...
    paragraphs: [
      ...
      'Platform; araç kartı oluşturma, QR etiket üretimi, müşteri etkileşim takibi ve ekip bazlı panel yönetimi gibi modüllerden oluşur.',
    ],
  },
  {
    ...
    bullets: [
      ...
      'Paylaşılan ekip hesaplarında yetki ve rol atamaları işletme sorumluluğundadır.',
    ],
  },
  {
